...
def get_macro_data(asset_class: str = "FX") -> Dict[str, Any]:
    ...
    # ── ISM PMI — MQL5 (real data) with CFNAI/IPMAN fallback ───────────
    ...
    result["ism_manufacturing"] = round(_ism_mfg["value"], 1) if _ism_mfg else fetch_fred_series("CFNAI", days=90)
    result["ism_services"] = round(_ism_svc["value"], 1) if _ism_svc else fetch_fred_series("IPMAN", days=90)
