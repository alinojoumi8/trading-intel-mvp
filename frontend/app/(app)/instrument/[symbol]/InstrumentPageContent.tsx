...
import { ContentItem, Instrument, getContentByInstrument, getInstrument } from "@/lib/api";
...
export default function InstrumentPageContent() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      setError(null);
      try {
        const [instrumentData, contentData] = await Promise.all([
          getInstrument(symbol),
          getContentByInstrument(symbol),
        ]);
